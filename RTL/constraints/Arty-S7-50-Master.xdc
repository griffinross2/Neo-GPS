...
## PMOD Header JA
set_property -dict {PACKAGE_PIN L17 IOSTANDARD LVCMOS33} [get_ports ja_0]
set_property -dict {PACKAGE_PIN L18 IOSTANDARD LVCMOS33} [get_ports ja_1]
...
set_property -dict {PACKAGE_PIN M16 IOSTANDARD LVCMOS33} [get_ports ja_4]
...
create_clock -period 200.000 -name mcu_sck -waveform {0.000 100.000} [get_nets ck_io3]
