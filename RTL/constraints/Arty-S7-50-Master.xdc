...
## PMOD Header JA
set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { ja_0 }]; #IO_L4P_T0_D04_14 Sch=ja_p[1]        CD
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { ja_1 }]; #IO_L4N_T0_D05_14 Sch=ja_n[1]        D3
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { ja_2 }]; #IO_L5P_T0_D06_14 Sch=ja_p[2]        CLK
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { ja_3 }]; #IO_L5N_T0_D07_14 Sch=ja_n[2]        D1
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { ja_4 }]; #IO_L7P_T1_D09_14 Sch=ja_p[3]        D2
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { ja_5 }]; #IO_L7N_T1_D10_14 Sch=ja_n[3]    
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { ja_6 }]; #IO_L8P_T1_D11_14 Sch=ja_p[4]        CMD
set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { ja_7 }]; #IO_L8N_T1_D12_14 Sch=ja_n[4]        D0


## PMOD Header JB
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { jb_0 }]; #IO_L9P_T1_DQS_14 Sch=jb_p[1]        Q0
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { jb_1 }]; #IO_L9N_T1_DQS_D13_14 Sch=jb_n[1]    Q1
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { jb_2 }]; #IO_L10P_T1_D14_14 Sch=jb_p[2]       I0
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { jb_3 }]; #IO_L10N_T1_D15_14 Sch=jb_n[2]       I1
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { jb_4 }]; #IO_L11P_T1_SRCC_14 Sch=jb_p[3]      DIN
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { jb_5 }]; #IO_L11N_T1_SRCC_14 Sch=jb_n[3]      SCK
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { jb_6 }]; #IO_L12P_T1_MRCC_14 Sch=jb_p[4]      GNSS_CLK
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { jb_7 }]; #IO_L12N_T1_MRCC_14 Sch=jb_n[4]      CS
