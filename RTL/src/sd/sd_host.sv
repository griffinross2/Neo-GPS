...
logic fifo_wr_en;
logic [10:0] fifo_wr_addr;
logic [10:0] fifo_rd_addr, next_fifo_rd_addr;
...
always_ff @(posedge gnss_clk, negedge nrst) begin
    if (~nrst) begin
        ...
        if (fifo_wr_en) begin
            fifo_wr_addr <= fifo_wr_addr + 11'd1;
        end
...
always_comb begin
    ...
    if (fifo_wr_en && (fifo_wr_addr == 11'd1023 || fifo_wr_addr == 11'd2047)) begin
...
always_comb begin
    ...
    if(data_next) begin
        next_fifo_rd_addr = fifo_rd_addr + 11'd1;
    end
    ...
    case (host_state)
        ...
        SD_HOST_CMD24: begin
            next_fifo_block_started = 1'b1;
            cmd_to_send = {1'b1, 6'd24, data_block_addr}; // CMD24
            next_cmd_start = 1'b0;
            resp_expected = 1'b1;
            if (cmd_resp_valid & ~cmd_start) begin
                next_data_block_addr = data_block_addr + 32'd1;
