    ...
    add_files -fileset sources_1 [ glob ../inc/*.vh ]
    add_files -fileset sim_1 [ glob ../inc/*.vh ]
    add_files -fileset constrs_1 [ glob ../constraints/*.xdc ]

    # Get the list of .vh files in the target directory
    set vh_files [glob -nocomplain -directory ../inc *.vh]
    ...
    add_files -fileset sources_1 [ glob ../src/spi/spi_device.sv ]
    add_files -fileset sources_1 [ glob ../src/dsp/fft/*.sv ]
    add_files -fileset sources_1 [ glob ../src/gps/*.sv ]
    add_files -fileset sources_1 [ glob ../src/frontend/frontend_config.sv ]
    add_files -fileset sources_1 [ glob ../top/gps_top.sv ]
    ...
    set_property top gps_top [get_fileset sources_1]
